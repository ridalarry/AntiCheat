...
public class AngleUtil {
    ...
    public static float getOffset(Player player, LivingEntity livingEntity) {
        ...
        double d2 = AngleUtil.clamp180(vector.getX() - vector2.getX());
        double d3 = AngleUtil.clamp180(vector.getY() - vector2.getY());
        double d4 = AngleUtil.getHorizontalDistance(location2, location);
        double d5 = AngleUtil.getDistance3D(location2, location);
        double d6 = d2 * d4 * d5;
    ...
    public static double[] getOffsets2(Player player, LivingEntity livingEntity) {
        ...
        double d3 = AngleUtil.getHorizontalDistance2(location2, location);
        double d4 = AngleUtil.getDistance3D2(location2, location);
        double d5 = d * d3 * d4;
